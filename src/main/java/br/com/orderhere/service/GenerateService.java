...
public class GenerateService {
    ...
    public String generateDescription() {
        ...
        int indexFood = ThreadLocalRandom.current().nextInt(foods.length);
        String randomFoods = foods[indexFood];
    ...
    public String generateNickName() {
        ...
        int indexNicksNames = ThreadLocalRandom.current().nextInt(nickNames.length);

        return nickNames[indexNicksNames];
    }
    ...
    public BigDecimal generateOrderPrice() {
        ...
        return new BigDecimal(randomMoney).setScale(2, BigDecimal.ROUND_HALF_EVEN);
    }
}